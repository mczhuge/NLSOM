...
class DDColor:
    def __init__(self, device):
        print(f"Initializing DDColor to {device}")
        self.device = device
    ...
    @prompts(name="DDColor (Image Colorization)",
...
if __name__ == "__main__":
    color_model = UNet(device="cuda:0")
    docs = color_model.inference("WechatIMG893.jpeg")
    print(docs)